...
class M_SaranaPrasarana extends CI_Model{
    ...
    function getDataSaranaRuangan($number,$offset){
			...
			$panjangRuangan = $this->input->post('panjangRuangan');
			$lebarRuangan = $this->input->post('lebarRuangan');
			...
			if($lebarRuangan != NULL || $panjangRuangan != NULL){
				if($lebarRuangan != NULL && $panjangRuangan != NULL){
					$this->db->where('lebar_ruangan >=', $lebarRuangan);
					$this->db->where('panjang_ruangan >=', $panjangRuangan);
				}elseif($lebarRuangan != NULL && $panjangRuangan == NULL){
					$this->db->where('lebar_ruangan >=', $lebarRuangan);
				}elseif($lebarRuangan == NULL && $panjangRuangan != NULL){
					$this->db->where('panjang_ruangan >=', $panjangRuangan);
				}
