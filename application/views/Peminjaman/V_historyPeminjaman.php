            ...
            <div class="col-6 col-md-6">
                <div class="d-flex flex-row-reverse bd-highlight">
                    <?php if ($this->session->userdata('status') != "pengguna") { ?>
                        <a class="btn btn-sm btn-success text-white mb-2 ml-1" href="<?php echo base_url("index.php?/Excel/exportDataPeminjaman"); ?>"><i class="fas fa-file-excel"></i> </a>
                    ...
                    <form class="pr-2 form-inline" action="<?= base_url() ?>index.php?/Peminjaman/historyPeminjaman" method="post">
                        <div class="form-group mb-2">
                            <input type="text" name="search" class="form-control-sm " placeholder="quick search" value="<?= $search; ?>">
                        </div>
                        <input type="submit" name="submit" class="btn btn-sm btn-primary mb-2" value="Search">
                    </form>
                </div>
            </div>
        </div>
        ...
        <div class="p-2 bg-white shadow">
            ...
            <form action="<?php echo base_url("index.php?/Peminjaman/historyPeminjaman"); ?>" method="post">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="<?= $pengguna; ?>" name="pengguna" placeholder="username / nama pengguna">
                </div>
                <div class="form-group">
                    <label for="exampleInputEmail1">Penyelenggara</label>
                    <input type="text" class="form-control" value="<?= $penyelenggara; ?>" name="penyelenggara">
                </div>
                <div class="form-group">
                    <label for="exampleInputEmail1">Jenis Peminjaman</label>
                    <select name="jenis" class="form-control">
                        <option value="">Pilih</option>
                        <option value="ruangan" <?php echo ($jenis == 'ruangan') ? 'selected="selected"' : ''; ?>>Ruangan</option>
                        <option value="barang" <?php echo ($jenis == 'barang') ? 'selected="selected"' : ''; ?>>Barang</option>
                    </select>
                </div>
                <div class="form-group">
                    ...
                    <select name="status" class="form-control">
                        <option value="">Pilih</option>
                        <option value="semua" <?php echo ($status == 'ya') ? 'selected="selected"' : ''; ?>>Semua</option>
                        <option value="setuju" <?php echo ($status == 'setuju') ? 'selected="selected"' : ''; ?>>Setuju</option>
                        <option value="terkirim" <?php echo ($status == 'terkirim') ? 'selected="selected"' : ''; ?>>Terkirim</option>
                        <option value="tolak" <?php echo ($status == 'tolak') ? 'selected="selected"' : ''; ?>>Tolak</option>
                    </select>
                </div>
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <label for="exampleInputEmail1">Tanggal Mulai</label>
                        <input type="date" value="<?= $tgl_mulai; ?>" name="tgl_mulai" class="form-control" placeholder="First name">
                    </div>
                    <div class="form-group col-md-6">
                        <label for="exampleInputEmail1">Tanggal Selesai</label>
                        <input type="date" value="<?= $tgl_selesai; ?>" name="tgl_selesai" class="form-control" placeholder="Last name">
                    </div>
                </div>
                <div class="form-row">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-9">
                        <input type="submit" name="submit" style="width:100%;" class="btn btn-primary" value="Submit">
                    </div>
                </div>
            </form>
        </div>
            ...
            <tbody>
                ...
                ?>
                    <tr class="text-center">
                        ...
                        <td <?php
                            if ($u->validasi_akademik == 'setuju') { ?> class="text-success" <?php } else if ($u->validasi_akademik == 'terkirim') { ?> class="text-warning" <?php } else if ($u->validasi_akademik == 'pending') { ?> class="text-darik" <?php } else { ?> class="text-danger" <?php }
                                                                                                                                                                                                                                                                                                ?>><?= $u->validasi_akademik; ?>
                        </td>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Export Data Peminjaman</h5>
