    ...
    <div class="col-md-4 order-md-2 mb-4">
      <div class="card shadow mb-4">
        ...
        <div class="card-body" style="height:500px; overflow-y: scroll;">
            <div class="my-2">
            <input type="text" id="myInput" onkeyup="myFunction()" placeholder="Cari ruangan" class="form-control">
            </div>
            ...
            <ul id="myUL" class="list-group mb-1 anyClass" >  
                ...
                <div class="justify-content-between lh-condensed d-flex">
                    <div>
                        ...
                        <div style="font-size:13px;" class="text-muted">Kapasitas <?= $u->kapasitas; ?> orang</div> 
                        <div style="font-size:13px;" class="text-muted">Ruangan <?= $u->jenis_ruangan; ?> </div>
                    </div>
                    <span class="text-muted"> 
                        <form action="<?php echo site_url('index.php?/Peminjaman/tambahSaranaPeminjaman'); ?>" method="post">
