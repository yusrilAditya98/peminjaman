<div class="container-fluid mt-4 mb-4">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-2">
            ...
            <form class="pr-2 form-inline" action="<?php echo base_url('index.php?/SaranaPrasarana/penggunaanRuangan');?>"  method="post">
      ...
      <div class="modal-content">
        <div>
            <div class="position-relative pl-3 mt-2 media-body">
                ...
                <div class="row">
                    <div class="col-md-3">Penyelenggara</div>
                    <div class="col-md-9">: <a class="text-700" ><input id="penyelenggara"  style="border:none" ></a></div>
                </div>
                <div class="row">
                    <div class="col-md-3">Jam</div>
                    <div class="col-md-9">: <a class="text-700" ><input  id="jam" style="border:none" ></a></div>
                </div>
                <div class="row">
                    <div class="col-md-3">Jam</div>
                    <div class="col-md-9">: <a class="text-700" ><input  id="ruangan" style="border:none" ></a></div>
                </div>
            </div>
        </div>
